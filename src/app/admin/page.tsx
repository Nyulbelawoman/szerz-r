...
type User = { email: string; plan: string; created_at: string; contract_count: number };
          ...
          <table className="w-full text-sm">
            <thead className="bg-slate-50 text-left text-xs text-slate-500">
              <tr>
                ...
                <th className="px-4 py-2">Szerződések</th>
              </tr>
            </thead>
            <tbody>
              {users.map((u) => (
                <tr key={u.email} className="border-t border-slate-100">
                  ...
                  <td className="px-4 py-2 text-slate-600">{u.contract_count} db</td>
                </tr>
              ))}
            </tbody>
          </table>
